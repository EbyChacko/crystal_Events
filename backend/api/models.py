...
class UserProfile(models.Model):
    ...
    can_manage_assets = models.BooleanField(default=False, help_text="Allow user to view the asset inventory")
    can_add_asset = models.BooleanField(default=False, help_text="Allow user to add, edit, and delete assets")
