...
const Financials = () => {
    ...
    const [tipAvailableBalance, setTipAvailableBalance] = useState(0);
    ...
    const fetchTipData = async () => {
        try {
            ...
            setTipAvailableBalance(res.data.available_balance || 0);
        } catch {
            // silently fail
        }
    };
        ...
        <div>
            ...
            <AnimatePresence>
                ...
                <div key="overview-cards" className={`grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-5 mb-8 md:mt-8 ${isOverviewOpen ? 'grid' : 'hidden md:grid'}`}>
                    ...
                    <StatCard icon={<Crown size={22} />} label="Tip Available" value={`€${tipAvailableBalance.toLocaleString('en-IE', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`} isPositive={tipAvailableBalance >= 0} delay={0.4} />
                </div>
            </AnimatePresence>
