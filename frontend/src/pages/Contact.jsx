...
const Contact = () => {
    ...
    return (
        ...
        <div className="font-sans relative overflow-hidden section-gold-glow">
            {/* Decorative orbs */}
            <div className="orb orb-gold w-[400px] h-[400px] -top-20 -right-20 opacity-[0.08]" />
            <div className="orb orb-teal w-[300px] h-[300px] bottom-20 -left-20 opacity-[0.06]" />

            <div className="pt-28 pb-28 lg:pt-32 lg:pb-36 px-6 md:px-12 lg:px-20 relative z-10">
                    ...
                    >
                        ...
                        <div className="space-y-5">
                            <div className="flex items-start gap-4">
                                <div className="bg-mustard-gold/10 p-3 rounded-xl text-mustard-gold">
                                    <Mail size={24} />
                                </div>
                                <div>
                    ...
                    >
                        {status === 'success' ? (
                            <div className="text-center py-12">
                                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-emerald-green/20 text-emerald-green mb-4">
                                    <Send size={32} />
                                </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                        className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 focus:outline-none focus:border-mustard-gold transition-colors text-white placeholder-white/20"
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        onChange={handleChange}
                                        className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 focus:outline-none focus:border-mustard-gold transition-colors text-white"
                                    >
                                ...
                                <button
                                    ...
                                    className="w-full bg-mustard-gold text-deep-teal font-bold uppercase tracking-widest py-3 rounded-full hover:brightness-110 transition-all duration-300 disabled:opacity-50 flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(238,192,89,0.25)]"
                                >
                                    {status === 'submitting' ? (
                                        <>
