...
import {
    ...
    CheckCircle2, Heart, Star, MapPin, Globe
} from 'lucide-react';
            ...
            <div className="font-sans text-white bg-background-dark">
                ...
                <section className="py-24 px-6 md:px-16 lg:px-28 bg-deep-teal rounded-t-[2rem]">
                    <div className="max-w-5xl mx-auto">
                        ...
                        >
                            <MapPin className="w-8 h-8 text-mustard-gold mx-auto mb-4" strokeWidth={1.5} />
                            <h3 className="text-xl font-bold mb-2">Service Area</h3>
                            <p className="text-white/60 max-w-xl mx-auto mb-8">
                                Based in Ballinasloe, Galway, we provide wedding planning services across all of Ireland.
                            </p>
                            <Link
                                to="/contact"
                                className="inline-flex items-center gap-2 px-8 py-4 bg-mustard-gold text-deep-teal font-bold uppercase tracking-widest rounded-lg hover:brightness-110 transition-all duration-300 shadow-[0_0_20px_rgba(238,192,89,0.35)] text-sm"
                            >
                                Contact Crystal Events Today
                            </Link>
                        </motion.div>
                    </div>
                </section>
