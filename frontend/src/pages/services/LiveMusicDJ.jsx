                                ...
                                <div className="space-y-3">
                                    {perfectFor.map((item, i) => (
                                        ...
                                        >
                                            <Link
                                                to={item.linkTo}
                                                className="flex items-center justify-between glass-card-light rounded-xl px-5 py-4 hover:border-mustard-gold/30 hover:text-mustard-gold transition-all duration-300 group"
                                            >
                                                <span className="text-deep-teal/70 text-sm group-hover:text-mustard-gold transition-colors duration-300">{item.label}</span>
