                    ...
                    <div className="py-24">
                        <div className="max-w-5xl mx-auto">
                            ...
                            >
                                ...
                                <h2 className="text-3xl md:text-4xl font-black leading-tight text-deep-teal">
                                    Why Choose{' '}
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                {whyUs.map((point, i) => (
                                    <motion.div
                                        ...
                                        viewport={{ once: true, amount: 0.18, margin: '0px 0px -80px 0px' }}
                                        transition={{ duration: 0.5, delay: i * 0.05, ease: 'easeOut' }}
                                        className="flex items-start gap-3 glass-card-light rounded-xl p-5 hover:border-mustard-gold/30 transition-all duration-300"
                                    >
