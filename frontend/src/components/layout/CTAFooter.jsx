    ...
    return (
        <div className="font-sans">
            ...
            <div className="section-cream relative overflow-hidden">
                ...
                {/* Decorative orb */}
                <div className="orb orb-gold w-[300px] h-[300px] top-0 right-1/4 opacity-[0.06]" />

                <div className="mx-auto max-w-5xl px-6 md:px-12 pt-24 pb-16 text-center relative z-10">
                    <span className="text-mustard-gold font-bold uppercase tracking-[0.3em] text-xs mb-4 block">
                        {label}
                    </span>
                    <h2 className="text-2xl md:text-4xl font-black leading-tight font-sans mb-4 text-deep-teal">
                        {title}
                    </h2>
                    <p className="mx-auto max-w-xl text-sm md:text-base text-deep-teal/50 mb-8 leading-relaxed">
                        {description}
                    </p>
            ...
            {/* ── Footer — Dark emerald ── */}
            <div className="section-emerald text-white relative overflow-hidden">
                <div className="absolute top-0 left-0 right-0 h-px gold-shimmer-line" />

                <div className="mx-auto max-w-7xl px-6 md:px-16 py-12 grid grid-cols-1 md:grid-cols-4 gap-10 relative z-10">
                ...
                {/* Copyright */}
                <div className="mx-auto max-w-7xl px-6 md:px-16 pb-8 border-t border-white/5 pt-6 flex flex-col md:flex-row justify-between items-center gap-4 relative z-10">
                    <p className="text-white/30 text-xs">&copy; {new Date().getFullYear()} Crystal Events Management. All rights reserved.</p>
