...
const CTAFooter = () => {
    return (
        <div className="bg-jungle-green rounded-t-[2rem] text-white font-sans">
            ...
            {/* ── Compact CTA ── */}
            <div className="mx-auto max-w-5xl px-6 md:px-12 pt-14 pb-12 text-center">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <Link
                        to="/contact"
                        className="w-full sm:w-auto px-8 py-3.5 bg-mustard-gold text-deep-teal font-bold uppercase tracking-widest rounded-lg hover:brightness-110 transition-all shadow-[0_0_20px_rgba(238,192,89,0.25)] text-sm"
                    >
                        Book Your Event
                    </Link>
                    <Link
                        to="/contact"
                        className="w-full sm:w-auto px-8 py-3.5 border border-white/20 text-white font-bold uppercase tracking-widest rounded-lg hover:border-mustard-gold hover:text-mustard-gold transition-all text-sm"
                    >
                        Contact Us
                    </Link>
                </div>
            ...
            <div className="mx-auto max-w-7xl px-6 md:px-16 py-12 grid grid-cols-1 md:grid-cols-4 gap-10">
                ...
                <div className="md:col-span-2 lg:col-span-1">
                    ...
                    <div className="flex gap-3">
                        <a href="#" className="h-9 w-9 flex items-center justify-center rounded-full bg-white/5 text-white hover:bg-mustard-gold hover:text-deep-teal transition-all">
                            <Facebook size={16} />
                        </a>
                        <a href="https://instagram.com/irl_crystalevents" target="_blank" rel="noopener noreferrer" className="h-9 w-9 flex items-center justify-center rounded-full bg-white/5 text-white hover:bg-mustard-gold hover:text-deep-teal transition-all">
                            <Instagram size={16} />
                        </a>
                    </div>
                </div>
